$(document).ready(function () {
  ...
  $('#search-button').on('click', function () {
    ...
    var endYear = 2017+"0101";
    var searchURL = "https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=2d6d8bb60364453d8ab1e776b1a25537&q=" + search+"&begin_date="+beginYear+"0101";
